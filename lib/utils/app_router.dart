...
import 'package:tracks_admin_app/screens/Units/UnitsPage.dart';
...
class AppRouter {
  ...
  static const String unitesScreen = "/UnitsScreen";
  ...
  Map<String, WidgetBuilder> routes() {
    return {
      ...
      AppRouter.unitesScreen: (context) => const UnitsHomePage(),
